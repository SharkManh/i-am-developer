...
const TaiXiuScreen = ({ initialMoney }) => {
  ...
  useEffect(() => {
          ...
          if (countdown > 0) {
            ...
            setTimeout(() => {
              if(gameOver){
                    const winAmount = gameResult === 'Tai' ? betTai * 0.9 : betXiu * 0.9;
                    const lossAmount = gameResult === 'Tai' ? betXiu : betTai;
                    setMoney(money + winAmount - lossAmount);
              }
              setTimeout(() => {
                setCountdown(15);
                setBetTai(0);
    ...
    <View style={styles.container}>
          ...
          <View style={styles.buttons}>
                    <View style={styles.inputContainer}>
                              ...
                              <View>
                                <Image source={betBox} style={styles.moneyContainerBackgroundImage} />
                                <TextInput
                                        style={styles.input}
      ...
      <View style={styles.moneyContainer}>
          ...
          <View style={styles.moneyContainerInfo}>
            ...
            <Text style={styles.moneyContainerText}>   {money.toFixed(2)}</Text> 
          </View>
      </View>
    </View>
  );
...
const DiceImage = ({src}) => {
          return (
                    <Image style={styles.diceImage} source={src} />
          )
}
...
const Timer = ({ countdown, gameOver, result }) => {
  ...
  return (
    <View style={timerStyle.timerWrapper}>{gameOver ? <Text style={timerStyle.text} children={result} /> : <TimerWithIcon countdown={countdown} />}</View>
  );
};
